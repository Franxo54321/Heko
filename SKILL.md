...
- **PROHIBIDO** usar emojis en cualquier parte del CSS, comentarios de CSS, nombres de clases, variables o valores de propiedades
- **PROHIBIDO** usar emojis en nombres de archivos, selectores o atributos HTML relacionados al estilo
- El código CSS debe ser limpio, semántico y profesional
- Los comentarios en CSS deben ser texto plano, sin caracteres especiales ni emojis
- Usar nombres de variables CSS descriptivos en inglés o español, nunca con emojis